    ...
    private void makeGetMyPrescription(String user_id) {
        ...
        CommonAsyTask task = new CommonAsyTask(params,
            ...
            public void VResponce(String response) {
                ...
                My_prescription_adapter adapter = new My_prescription_adapter(My_prescriptionActivity.this, my_prescription_modelList);
                if (getIntent().hasExtra("pres_id")) {
                    adapter.pres_id = getIntent().getStringExtra("pres_id");
                }
