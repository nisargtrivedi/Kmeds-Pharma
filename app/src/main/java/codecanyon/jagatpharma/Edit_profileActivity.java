...
//                startActivityForResult(cameraIntent, CAMERA_CAPTURE_IMAGE_REQUEST_CODE1);
    ...
    private void launchCameraIntent() {
        Intent intent = new Intent(Edit_profileActivity.this, ImagePickerActivity.class);
    ...
    private void selectOption(){
        ImagePickerActivity.showImagePickerOptions(Edit_profileActivity.this, new ImagePickerActivity.PickerOptionListener() {
            @Override
    ...
    public String saveImage(Bitmap myBitmap) {
        ...
        try {
            ...
            MediaScannerConnection.scanFile(Edit_profileActivity.this,
...
//        String path = saveImage(thumbnail);
        ...
        String path="";
        try {
            Bitmap bitmap = MediaStore.Images.Media.getBitmap(Edit_profileActivity.this.getContentResolver(), fpath);
    ...
    private String onSelectFromGalleryResult(Intent data) {
        ...
        try {
            ...
            Toast.makeText(Edit_profileActivity.this,"Try Again...",Toast.LENGTH_LONG).show();
        }
        return path;
    }
    @Override
